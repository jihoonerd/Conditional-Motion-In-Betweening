...
def test(opt, device):
    ...
    lafan_dataset = LAFAN1Dataset(lafan_path=opt.data_path, processed_data_dir=opt.processed_data_dir, train=False, target_action=['walk', 'dance'], device=device, start_seq_length=30, cur_seq_length=30, max_transition_length=30)
