...
def test(opt, device):
    ...
    lafan_dataset_test = LAFAN1Dataset(lafan_path=data_path, processed_data_dir=opt.processed_data_dir, train=False,  target_action=['dance', 'jump'], start_seq_length=30, cur_seq_length=30, max_transition_length=30, device=device)
                ...
                for cond_code in cond_codes:
                    ...
                    if infogan_cont_code ==0 :
                        ...
                        if control_latent == 'cond': 
                            ...
                            infogan_disc_code_gen[:,conditioning_disc_code] = 1
                            infogan_cont_code_gen = torch.zeros(current_batch_size, infogan_cont_code)
                            infogan_cont_code_gen[:,conditioning_cont_code] = 3
